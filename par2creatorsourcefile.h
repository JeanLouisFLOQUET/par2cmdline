...
//  Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA
	...
	class Par2CreatorSourceFile {
		...
		public:
			...
			bool Open(u32 VerboseLevel, const CommandLine::ExtraFile &extrafile, u64 blocksize, bool deferhashcomputation, string basepath);
			void Close(void);

			// Recover the file description and file verification packets in the critical packet list.
